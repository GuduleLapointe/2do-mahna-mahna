...
- Never make changes directly in output/, they would be overriden automatically by the dev server and/or the deploy processes.
- Source code is located in templates/
...
2do-aggregator
├── *.md
├── cron.sh		// Full update task for cront
├── package.json
├── aggregator.php
...
├── logs/
├── output/		// Auto-generated by scripts and fswatch, DO NOT MODIFY
├── parsers/	// Input converters
├── templates/	// Source files used to populate output
├── tests/		// Test Units
