...
if (
	strpos($ics_data, "BEGIN:VCALENDAR") === false &&
	strpos($ics_data, "BEGIN:VEVENT") === false
) {
...
try {
	...
	// Log the error
	error_log(
		"$scriptName $url error " . $e->get_code() . ": " . $e->get_message(),
	);
	die(6);
}
if ($vevents === false) {
